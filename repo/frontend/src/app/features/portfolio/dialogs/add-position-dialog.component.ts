...
@Component({
  ...
  template: `
    <h2 mat-dialog-title i18n="@@portfolio.dialog.add-title">Yeni Pozisyon</h2>

    <form [formGroup]="form" (ngSubmit)="submit()">
      <mat-dialog-content class="grid gap-4 sm:grid-cols-2">
        <div class="sm:col-span-2">
          <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200" i18n="@@portfolio.dialog.coin">Coin</label>
          <app-coin-picker
        ...
        <div>
          ...
          <mat-form-field appearance="outline" class="w-full">
            <input matInput formControlName="quantity" inputmode="decimal" placeholder="0.50" i18n-aria-label="@@portfolio.dialog.quantity" aria-label="Adet" class="w-full">
          </mat-form-field>
        </div>
